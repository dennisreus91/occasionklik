...
def chat():
    ...
    **Input voor het gesprek**  
       ...
       - Haal eerst relevantie informatie op voor professioneel advies zoals type auto, waar de auto voor gebruikt zal worden, budget, voorkeursmerk, voorkeurmodel en de belangrijkste opties.
